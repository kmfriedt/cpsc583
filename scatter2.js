...
function setupModel(id, xax, yax, xtitle, ytitle, avg1, avg2){
    ...
    d3.csv("evdata2.csv").then(function (d){
       drawScatter2(id, d, xax, yax, xtitle, ytitle, avg1, avg2)
    });
}
...
function drawAxesLeft(text, chart, scale, left, top, width, height){
    chart.append("g")
...
function drawAxesBottom(text, chart, scale, left, bottom, height, width){
    chart.append("g")
...
function drawScatter2(id, data, xax, yax, xtitle, ytitle, avg1, avg2 ) {
    ...
    drawAxesLeft(ytitle, chart, yScale, margins.left, margins.top, innerWidth, totalHeight);
    drawAxesBottom(xtitle, chart, xScale, margins.left, innerHeight + margins.top,
